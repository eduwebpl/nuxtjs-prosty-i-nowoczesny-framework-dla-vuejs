  ...
  <article class="content">
   ...
   <table class="box full-bio">
    ...
    <tr>
     <td colspan="2">
      <figure>
       <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Janusz_Korczak.PNG/220px-Janusz_Korczak.PNG">
       <figcaption>
   ...
   <p> During World War I, in 1914 Korczak became a military doctor with the rank of lieutenant. He served
